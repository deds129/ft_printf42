...
int main()
{
	...
	int ret;
//		printf("\n---------------------------------------------\n");
//	ret = printf("%10c",86); printf("$ return: %d",ret);
//	printf("\n");
//	ret = ft_printf("%10c",86); printf("$ return: %d",ret);
//	printf("\n");
...
//	ret = printf("%.20s","Hello world"); printf("$ return: %d",ret);
//	printf("\n");
//	ret = printf("%.*s",-20,"Hello world"); printf("$ return: %d",ret);
//	printf("\n");
...
//	ret = ft_printf("%.20s","Hello world"); printf("$ return: %d",ret);
//	printf("\n");
//	ret = ft_printf("%.*s", -20,"Hello world"); printf("$ return: %d",ret);
//	printf("\n");
...
//
	...
	printf("\n");
	ret = printf("%2.2d",423232342); printf("$ return: %d",ret);
	printf("\n");
	ret = printf("%-.15d",-424342242); printf("$ return: %d",ret);
	printf("\n");
	ret = printf("%1.15d",-424342242); printf("$ return: %d",ret);
	printf("\n");
